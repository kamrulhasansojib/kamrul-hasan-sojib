...
export const CertificationsSection: React.FC<CertificationsSectionProps> = ({
  ...
  const [activePreview, setActivePreview] = useState<Certification | null>(
    null,
  );
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-6">
          <div>
            ...
            <p className="text-zinc-300 text-sm sm:text-base lg:text-lg mt-3 max-w-xl leading-relaxed">
              Industry-recognized professional certifications and academic
              qualifications validating software engineering, cloud
              architecture, and algorithms mastery.
            </p>
          </div>
          ...
          {filteredCerts.length > 1 && (
            <div className="mt-8 flex items-center justify-between border-t border-zinc-900 pt-4">
              ...
              <div className="text-xs sm:text-sm font-mono text-zinc-400">
                ...
                of <span className="text-zinc-200">{filteredCerts.length}</span>
              </div>
        ...
        >
          ...
          >
            ...
            <div className="rounded-2xl overflow-hidden border border-zinc-800 bg-zinc-900 max-h-[50vh] flex items-center justify-center shadow-inner">
              <img
                src={resolveImageUrl(
                  activePreview.certificateImage,
                  "https://images.unsplash.com/photo-1607799279861-4dd421887fb3?q=80&w=800&auto=format&fit=crop",
                )}
