          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-6">
            <div>
              ...
              <div className="space-y-5 text-zinc-300 text-base sm:text-lg leading-relaxed font-normal">
                <p>
                  Hello! I'm {name}, a passionate Computer Science
                  undergraduate. My fascination with logic and problem-solving
                  led me to the world of software development, where I strive to
