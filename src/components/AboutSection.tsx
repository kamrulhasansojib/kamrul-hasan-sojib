          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-6">
            <div>
              ...
              <div className="space-y-5 text-zinc-300 text-base sm:text-lg leading-relaxed font-normal">
                <p>
                  Hello! I'm {name}, a passionate Computer Science undergraduate
                  and a react developer. I build modern, responsive, and
                  user-friendly interfaces with clean, maintainable code and
                  attention to detail.
                </p>

                <p>
                  Currently, I specialize in the MERN stack (MongoDB, Express,
                  React, Node), focusing on building seamless web applications.
                  I believe that writing clean, efficient, and scalable code is
                  not just a preference but a necessity in the modern tech
                  landscape.
                </p>

                <p>
                  Beyond web development, I work on AI/Deep Learning—especially
                  NLP—and I enjoy problem solving through competitive
                  programming, where I practice algorithms and write efficient
                  solutions in C/C++.
                </p>
              </div>
            </div>
